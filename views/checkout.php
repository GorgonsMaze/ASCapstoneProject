                        ...
                        <div class="col s12 m8 l6 offset-m2 offset-l3" id="validateAnimate">
                            <ul class="collection with-header center-align">
                                ...
                                <li class="collection-item" id="chk-collection">
                                    <p>
                                        <input name="product" type="radio" id="chkEHR"
                                               title="Please check off correct product" class="with-gap validate"
                                               value="EHR Suite"/>
                                        <label for="chkEHR" class="chk-ehr-label">Advanced EHR Suite - <i>$199.99
                                                /month</i></label>
                                    </p>
                                    <p>
                                        <input name="group1" type="radio" id="chkBilling" disabled="disabled"/>
                                        <label for="chkBilling">Advanced Medical Billing Suite - <i>$79.99
                                                /month</i></label>
                                    </p>
                                    <p>
                                        <input name="group1" type="radio" id="chkPortal" disabled="disabled"/>
                                        <label for="chkPortal">Advanced Patient Portal Suite - <i>$149.99
                                                /month</i></label>
                                    </p>
                                </li>
                            </ul>
                            ...
                            <div class="card chk-out-card">
                                <div class="card-content billing-content">
                                    <div class="row">
                                        ...
                                        <div class="require center-align">* All fields required</div>
                                        <br/>
                                    </div>
                                    <div class="row">
                                        <!-- First Name-->
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="first_name" placeholder="John" type="text" name="fName"
                                                       pattern="^[a-zA-Z'.,\s-]{2,35}$" title="Enter first name"
                                                       class="validate" required="required" aria-required="true">
                                                <label for="first_name"><b>First Name</b></label>
                                            </div>
                                            <!-- Last Name-->
                                            <div class="input-field col s6">
                                                <input id="last_name" placeholder="Juggerknot" type="text" name="lName"
                                                       pattern="^[a-zA-Z'.,\s-]{2,50}$" title="Enter last name"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                <input id="address_one" placeholder="123 Holiday Lane" type="text"
                                                       name="address" title="Enter your street address" class="validate"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="address_two" placeholder="Apartment 2C" type="text"
                                                       name="address2" title="Enter secondary address">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="city" placeholder="Narnia" type="text" name="city"
                                                       title="Enter your city or town" class="validate" required=""
                                                       aria-required="true">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <select id="states" title="Select a state" name="state" class="validate"
                                                        required="" aria-required="true">
                                                    <option value="None" class="grey-text" disabled selected>Select a
                                                        State
                                                    </option>
                                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <!-- CHECK VALIDATION ******************* -->
                                                <input id="phone_number" placeholder="1234567890" type="text"
                                                       name="phoneNumber" pattern="^\d{10}$"
                                                       title="Enter your 10 digit phone number with dashes ex. 508-234-1233"
                                                       class="validate" required="" aria-required="true">
                            ...
                            <div class="card chk-out-card">
                                <div class="card-content billing-content">
                                    <div class="row">
                                        ...
                                        <div class="require hide-on-small-only center-align">* All fields required</div>
                                        <br/>
                                    </div>
                                    <div class="row">
                                        <div class="row">
                                            <!-- Credit Card Type  -->
                                            <div class="input-field col s12">
                                                <select id="cc_type" title="Select a Card Type" name="ccType"
                                                        type="select" class="validate" required="" aria-required="true">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="cc_number" placeholder="0000000000000000" type="text"
                                                       name="ccNum" pattern="^[1-9][0-9]{11,15}$"
                                                       title="Enter credit card number" class="validate" required=""
                                                       aria-required="true">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="cc_name" placeholder="First Last" type="text" name="ccName"
                                                       pattern="^[a-zA-Z'.,\s-]{2,50}$" title="Enter full name on card"
                                                       class="validate" required="" aria-required="true">
                                        ...
                                        <div class="row">
                                            <!-- Month Expr -->
                                            <div class="input-field col s6">
                                                <select id="cc_month" title="Select a month" name="ccExpMo"
                                                        type="select" class="validate" required="" aria-required="true">
                                            ...
                                            <!-- Year Expr -->
                                            <div class="input-field col s6">
                                                <select id="cc_year" title="Select a year" name="ccExpYr" type="select"
                                                        class="validate" required="" aria-required="true">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="cc_ccv" placeholder="Ex: 121" type="text" name="ccCCV"
                                                       pattern="^[1-9][0-9]{2,3}$"
                                                       title="Enter your CCV number (3 or 4 digits)" class="validate"
                                                       required="" aria-required="true">
                                                <label for="cc_ccv"><b>CCV</b></label>
                                            </div>
                                            <div class="col s6">
                                                <div class="whats-CCV">
                                                    <a class="chk-links tooltipped" data-position="bottom"
                                                       data-delay="50"
                                                       data-tooltip="CCV is the final 3 or 4 digits of the number printed on the back of your card"
                                                       href="#!">What is this?</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="center-align tos" id="tocBox">
                                            ...
                                            <input type="checkbox" class="filled-in" name="terms"
                                                   id="chk_termsOfService" title="Please agree to the terms of service"
                                                   required="" aria-required="true"/>
                                            <!-- TOS Modal Trigger -->
                                            <label for="chk_termsOfService"><a href="#tosModal"
                                                                               class="chk-links modal-trigger">Terms of
                                                    Service</a></label>
                                        </div>
                                        <!-- Modal Structure -->
                                        <div id="tosModal" class="modal modal-fixed-footer">
                                            <div class="modal-content open-sans3 tos-contents">
                                                ...
                                                <ol type="a">
                                                    <li>
                                                        ...
                                                        materials
                                                        (information or software) on Protech Solutions's web site for
                                                        personal,
                                                        ...
                                                        <ol type="i">
                                                            ...
                                                            <li>attempt to decompile or reverse engineer any software
                                                                contained on Protech Solutions's web site;
                                                            </li>
                                                            <li>remove any copyright or other proprietary notations from
                                                                the materials; or
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        these restrictions and may be terminated by Protech Solutions at
                                                ...
                                                <ol type="a">
                                                    <li>
                                                        The materials on Protech Solutions's web site are provided "as
                                                        is". Protech Solutions makes no warranties, expressed or
                                                        implied, and hereby disclaims and negates all other warranties,
                                                        including without limitation, implied warranties or conditions
                                                        of merchantability, fitness for a particular purpose, or
                                                        non-infringement of intellectual property or other violation of
                                                        rights. Further, Protech Solutions does not warrant or make any
                                                ...
                                                <h5>4. Limitations</h5>
                                                <p>In no event shall Protech Solutions or its suppliers be liable for
                                                    any damages (including, without limitation, damages for loss of data
                                                    or profit, or due to business interruption,) arising out of the use
                                                    or inability to use the materials on Protech Solutions's Internet
                                                    site, even if Protech Solutions or a Protech Solutions authorized
                                                ...
                                                <p>The materials appearing on Protech Solutions's web site could include
                                                    technical, typographical, or photographic errors. Protech Solutions
                                                    does not warrant that any of the materials on its web site are
                                                    accurate, complete, or current. Protech Solutions may make changes
                                                    to the materials contained on its web site at any time without
                                                    notice. Protech Solutions does not, however, make any commitment to
                                                    update the materials.</p>

                                                <h5>6. Links</h5>

                                                <p>Protech Solutions has not reviewed all of the sites linked to its
                                                    ...
                                                    endorsement by Protech Solutions of the site. Use of any such linked
                                                    web site is at the user's own risk.</p>

                                                <h5>7. Site Terms of Use Modifications</h5>

                                                <p>Protech Solutions may revise these terms of use for its web site at
                                                ...
                                                <p>Any claim relating to Protech Solutions's web site shall be governed
                                                    by the laws of the State of Rhode Island without regard to its
                                            ...
                                            <div class="modal-footer">
                                                <a href="#!"
                                                   ...
                                                   id="tosAgreeBtn">Agree</a>
                                            </div>
                                        </div>
                                        <!-- Purchase Button -->
                                        <div class="center-align">
                                            <button class="btn waves-effect waves-light" type="submit" name="action"
                                                    value="completePurchase" id="chkOutBtn">Purchase
